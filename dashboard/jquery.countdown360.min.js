/*
         ...
         *
         *  https://github.com/nledenyi/dashboard
...
;(function ($, window, document, undefined) {
    var pluginName = "countdown360",
        defaults = {
            ...
            strokeStyle: "#00a3e0",          // the color of the stroke
            strokeWidth: undefined,          // the stroke width, dynamically calulated if omitted in options
            fillStyle: "#ff0266",            // the fill color
            fontColor: "#fedd00",            // the font color
            fontFamily: "sans-serif",        // the font family
            fontSize: undefined,             // the font size, dynamically calulated if omitted in options
            fontWeight: 700,                 // the font weight
            autostart: false,                // start the countdown automatically
            seconds: 20,                     // the number of seconds to count down
...
processParam = function (parameter, value) {
    ...
    switch (parameter) {
        case "seconds" :
            countdown.settings.seconds = parseInt(value);
            break;
        case "fontWeight" :
            countdown.settings.fontWeight = parseInt(value);
            break;
        case "radius" :
            countdown.pause();
        ...
        case "strokeWidth" :
            ...
            break;
        case "fontSize" :
            countdown.settings.fontSize = parseFloat(value);
            break;
        case "direction" :
            countdown.settings.direction = (String(value) == "cw" ? "cw" : "ccw");
            break;
        case "strokeStyle" :
            countdown.pen.strokeStyle = String(value);
            break;
        case "fillStyle" :
            countdown.settings.fillStyle = String(value);
            break;
        case "fontColor" :
            countdown.settings.fontColor = String(value);
            break;
        case "fontFamily" :
            countdown.settings.fontFamily = String(value);
            break;
        case "label" :
            countdown.settings.label = String(value).split(",");
            break;
        case "smooth" :
            countdown.pause();
